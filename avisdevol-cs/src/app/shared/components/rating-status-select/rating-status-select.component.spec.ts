...
describe('RatingStatusSelectComponent', () => {
    ...
    describe('Component initialization', () => {
        ...
        it('should have access to status options', () => {
            ...
            expect(component.statusOptions.length).toBe(4); // ALL, PROCESSED, PUBLISHED, REJECTED
        });
    });
    ...
    describe('Status options rendering', () => {
        it('should render all status options', async () => {
            ...
            expect(options.length).toBe(4); // ALL, PROCESSED, PUBLISHED, REJECTED
        });
        ...
        it('should render translated status labels', async () => {
            ...
            const options = await select.getOptions();
            const expectedLabels = ['All', 'Processed', 'Published', 'Rejected'];
    ...
    describe('Translation integration', () => {
        ...
        it('should translate status option labels', async () => {
            ...
            const options = await select.getOptions();
            const expectedTranslations = ['Tous', 'Traité', 'Publié', 'Rejeté'];

            for (let i = 0; i < options.length; i++) {
                const optionText = await options[i].getText();
                expect(optionText).toContain(expectedTranslations[i]);
            }
        });
    });
    ...
    describe('Visual styling', () => {
        ...
        it('should apply correct layout classes to status options', async () => {
            ...
            const statusOptionDivs = fixture.debugElement.queryAll(By.css('mat-option div.flex'));
        ...
        it('should apply correct styling to colored dots', async () => {
            ...
            const dots = fixture.debugElement.queryAll(By.css('mat-option div.w-3.h-3.rounded-full'));
